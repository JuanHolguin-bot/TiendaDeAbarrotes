...
public class ListaProductos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        DefaultTableModel model = new DefaultTableModel(new String[]{"ID", "Nombre", "Tipo", "Precio", "Cantidad", "Proveedor", "Fecha Vencimiento"}, 0);
    ...
    private void btnVentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVentaActionPerformed
        // Pasar el nombre del usuario y la tabla jtProductos a la ventana Ventas
        Ventas ventanaVentas = new Ventas(usuario, jtProductos);
