...
public class Ventas extends javax.swing.JFrame {
    ...
    public Ventas(IProductoManager productoManager, IStockManager stockManager, String usuario, ListaProductos listaProductos) {
        ...
        initComponents();
        lblFecha.setText("Fecha: " + java.time.LocalDate.now().format(java.time.format.DateTimeFormatter.ofPattern("yyyy-MM-dd")));
    ...
    private void initComponents() {
        ...
        lblFecha.setFont(new java.awt.Font("Segoe UI", 0, 14));
        lblFecha.setText("Fecha: ");

        // Agregar lblFecha al panel superior (jPanel2)
...
>>>>>>> Develop
    ...
    private void btnGenerarVentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarVentaActionPerformed
        try {
            ...
            double totalVenta = gestorVenta.calcularMontoTotal(venta);
